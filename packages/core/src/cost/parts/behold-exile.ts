...
export class CostBeholdExile extends CostPart {
  readonly kind = "beholdExile";
  constructor(
...
CostPartRegistry.register(
  "beholdExile",
  (d) => new CostBeholdExile(d.amount as string, d.type as string, d.description as string | undefined),
);
