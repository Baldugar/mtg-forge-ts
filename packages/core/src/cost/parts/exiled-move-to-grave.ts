...
export class CostExiledMoveToGrave extends CostPart {
  readonly kind = "exiledMoveToGrave";
  constructor(
...
CostPartRegistry.register(
  "exiledMoveToGrave",
  (d) => new CostExiledMoveToGrave(d.amount as string, d.type as string, d.description as string | undefined),
);
