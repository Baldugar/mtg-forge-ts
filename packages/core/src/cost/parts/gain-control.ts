...
export class CostGainControl extends CostPart {
  readonly kind = "gainControl";
  constructor(
...
CostPartRegistry.register(
  "gainControl",
  (d) => new CostGainControl(d.amount as string, d.type as string, d.description as string | undefined),
);
